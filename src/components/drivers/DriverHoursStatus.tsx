...
// Each ring shows DRIVEN hours in the centre and remaining headroom below.
// When the driver has tachograph entries awaiting approval, the footer becomes
// an Approve/Reject panel (Approve overrides our estimate; Reject keeps ours).
