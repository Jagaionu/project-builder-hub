...
function whPin(code: string, zoom: number): string {
  ...
  ">
    ...
    ${zoom > 9 ? `<span style="font-size:11.5px;font-weight:700;color:#202124;letter-spacing:.04em">${code.toUpperCase()}</span>` : ""}
  </div>`;
}
